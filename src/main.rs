...
impl<'a> Player<'a> {
    pub fn new(pos: Point, texture: Texture<'a>, sprite: Rect, moving: Movement) -> Self {
	Self {
	    pos,
	    texture,
	    sprite,
...
fn main() -> Result<(), String> {
    ...
    let texture_1 = texture_creator.load_texture("../assets/reaper.png")?;
    let texture_2 = texture_creator.load_texture("../assets/bardo.png")?;
    ...
    let mut player = Player::new(Point::new(50,50), texture, Rect::new(0,0,26,36), movement_struct);
    let player_1 = Player::new(Point::new(50,50), texture_1, Rect::new(0,0,26,36), movement_struct);
    let player_2 = Player::new(Point::new(75,75), texture_2, Rect::new(0,0,26,36), movement_struct);
